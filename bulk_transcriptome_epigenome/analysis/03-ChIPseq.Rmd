...
Load tumor data including differential expression analysis with filtering, created in the document `01`:
...
For ChIPseq levels, for each gene, take the mean across transcripts:
...
## Crossing epigenomics with RNAseq

Here, we'll cross histone mark enrichment with gene-wise scores from differential
gene expression analysis based on bulk RNAseq.
