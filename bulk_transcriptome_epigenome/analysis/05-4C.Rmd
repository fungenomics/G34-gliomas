...
```{r human_pdgfra_plot, fig.width = 7, fig.height = 3}
...
```{r mouse_pdgfra_plot, fig.width = 7, fig.height = 3}
...
```{r human_gsx2_plot, fig.width = 7, fig.height = 3}
...
```{r mouse_gsx2_plot, fig.width = 7, fig.height = 3}
