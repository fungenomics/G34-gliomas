...
```{r targeted_dge_serum only, fig.width = 14, fig.height = 7}
...
```{r dlx_serum_boxplot, width = 5, height = 3}
...
```{r targeted_dge_nsm, fig.width = 14, fig.height = 7}
...
```{r dlx_stem_boxplot, width = 5, height = 3}
...
```{r viz_ssgsea, width = 2.5, height = 3}
