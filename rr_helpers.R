...
rr_plot_grid <- function(df, plot_num, ...) {
  ...
  if (!interactive()) {
    ...
    # Output a message with path to source data file
    # message("...writing source data of plot_grid to ", path_from_here(src_path))
