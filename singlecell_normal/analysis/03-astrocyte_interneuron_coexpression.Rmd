...
Given that we observe a dual neuronal-astrocytic gene expression program in the tumors,
...
Here, we'll get the leading edge genes from the [GSEA analysis](https://github.com/fungenomics/G34-gliomas/blob/master/bulk_transcriptome_epigenome/analysis/02-GSEA.Rmd),
for one human
...
Load Seurat object with all samples combined. The integration was done in Seurat V3, so here,
we re-constitute a V2 object from the V3 object, since we are using Seurat V2 throughout this analysis:
